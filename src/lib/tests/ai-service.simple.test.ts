/**
 * Simple Unit Tests for AI Service Functions
 *
 * This file contains unit tests for the extractMainContent function
 * which doesn't have external dependencies.
 *
 * @file ai-service.simple.test.ts
 */

import { describe, expect, it } from "bun:test";

// Import the function directly
import { extractMainContent } from "~/lib/ai-service/services";
