...
describe("AI Service - processChatMessage", () => {
  ...
  it("should process chat message and deny access", async () => {
    ...
    const mockResponse = {
      response: "I understand you want a break, but watching videos isn't related to your assignment. Consider taking a 10-minute walk instead to refresh your mind.",
